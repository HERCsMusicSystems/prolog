...
[[help CLOSURE]
	[command_helper "CLOSURE [*atom : *x]"]
	[write "If *atom is variable, then a new atom is created.\n"]
	[write "Creates a machine clause, which contains a number of atoms\n"]
	[write "equal to the number of element on the list *x.\n"]
	[write "Each of those atoms is a VARIABLE with\n"]
	[write "initial value taken from the list *x.\n"]
	[write "Normally a closure returns the list of its atoms.\n"]
	[write "However, it can also contain a separate value.\n"]
	[write "You can assign a value only once.\n"]
	[write "If you assign a value to the closure then it will\n"]
	[write "always return this value instead of the list of its atoms.\n"]
	[write "Example:\n"]
	[write "	[[closure *atom *locals *parameters *term]\n"]
	[write "		[MAP *locals *local *values]\n"]
	[write "		[CLOSURE *atom : *values]\n"]
	[write "		[*atom : *atoms]\n"]
	[write "		[eq *local *atoms]\n"]
	[write "		[*atom [*term : *parameters]]]\n"]
	]
[[help closure]
	[command_helper "closure [*atom *locals *parameters *term]"]
	[write "Creates a closure with a value.\n"]
	[write "Good for creating procedures with internal state.\n"]
	[write "You can call the procedure as follows:    res [[*atom *body : *parameters] : *body]\n"]
	[write "or simply us the helper macro:            res [[call *atom : *parameters]]\n"]
	[write "Macrodefinition:\n"]
	[list closure]
	]
[[help call]
	[command_helper "call [*atom : *parameters]"]
	[write "Retrieves a body of the procedure from a closure\n"]
	[write "associated with the *atom, applies *parameters and executes is.\n"]
	[write "Macrodefinition:\n"]
	[list call]
	]
[[help BLOCK]
	[command_helper "BLOCK [*declarations : *body]"]
	[write "Creates anonymous closure and executes the *body.\n"]
	[write "Macrodefinition:\n"]
	[list BLOCK]
	]
[[help MAP]
